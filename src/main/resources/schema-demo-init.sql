...
INSERT INTO CBMS_BBS VALUES (1, 'notice', '제목입니다.#1', 'admin', CURRENT_TIMESTAMP(), NULL, NULL);
INSERT INTO CBMS_BBS VALUES (2, 'notice', '제목입니다.#2', 'judge', CURRENT_TIMESTAMP(), NULL, NULL);


CREATE TABLE CBMS_BBS_CONTENT (
  BBS_ID INTEGER  NOT NULL,
  CONTENT CLOB,
  PRIMARY KEY(BBS_ID),
  CONSTRAINT CBMS_BBS_CONTENT_FK
    FOREIGN KEY (BBS_ID)
    REFERENCES CBMS_BBS(ID) ON DELETE CASCADE
);
INSERT INTO CBMS_BBS_CONTENT VALUES (1, '너무 길다...');
INSERT INTO CBMS_BBS_CONTENT VALUES (2, '너무 짧다...');
